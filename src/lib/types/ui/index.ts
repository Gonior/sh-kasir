export type IconName = 'open-padlock' | 'padlock' | 'chat' | 'qr-code' | 'file-edit' | 'save' | 'archive'  | 'eraser' | 'file-text' | 'repeat' | 'repeat-1' | 'arrow-left-right' | 'grip-vertical' | 'receipt' | 'filter' |'edit' | 'stack' | 'emoji-sad' | 'loading' | 'book' | 'folder' | 'power' | 'building' | 'printer' | 'server'| 'receipt-percent' | 'icon' |'minus' | 'question-mark' | 'home' | 'cog-8-tooth' | 'cube' | 'user-circle' | 'user' | 'ellipsis-vertical' | 'information-circle' | 'key' | 'plus' | 'trash' | 'close' | 'bell' | 'search' | 'bar' | 'refresh' | 'arrow' | 'arrow-long' | 'chevron-up-down' | 'chevron' | 'check' | 'logout' | 'bag' | 'calc' | 'wallet' | 'sun' | 'moon'
